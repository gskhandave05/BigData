...
public class AvergeDelayDriver extends Configured implements Tool {
  public static void main(String[] args) throws Exception {	  
    	int exitCode = ToolRunner.run(new Configuration(), new AvergeDelayDriver(),args);
...
//Initializing the map reduce job
	...
	job.setJarByClass(AvergeDelayDriver.class);
	job.setJobName("AverageFlightDelay");
	...
	job.setMapperClass(AverageFlihtDelayMapper.class);
	job.setReducerClass(AverageFlightDelayReducer.class);
	job.setCombinerClass(AverageFlightDelayCombiner.class);
	
	job.setMapOutputKeyClass(Text.class);
    job.setMapOutputValueClass(FlightDelayPair.class);
