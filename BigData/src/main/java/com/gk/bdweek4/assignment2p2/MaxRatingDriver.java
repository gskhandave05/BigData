 ...
 *
 */
public class MaxRatingDriver extends Configured implements Tool {
	public static void main(String[] args) throws Exception {
	
		int exitCode = ToolRunner.run(new Configuration(),new MaxRatingDriver(), args);
	...
	public int run(String[] args) throws Exception {
		...
		if (args.length != 2) {
		    ...
		    job.setJarByClass(MaxRatingDriver.class);
